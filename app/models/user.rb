class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
         ...
         validates :fast_kana_name,      presence: true,format: { with: /[ァ-ヶ一]/, message: '全角文字を使用してください' }
         validates :middle_kana_name,    presence: true,format: { with: /[ァ-ヶ一]/, message: '全角文字を使用してください' }
